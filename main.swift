...
class Map {
  ...
  static func latLonToTileId(lat: Double, lon: Double, zoom: Double) -> FractionalTileCoord {
    ...
    let acc: UInt64 = [
      ...
      1_398_101, 5_592_405, 22_369_621, 89_478_485, 357_913_941, 1_431_655_765,
    ][Int(zoom)]
  ...
  static func fetchBuildings(lat: Double, lon: Double) async throws -> [Layer.Feature] {
    ...
    let header = headerData.withUnsafeBytes { d in
      ...
      return (
        ...
        minLon: unalignedInt32(offset: 102) / 10_000_000,
        minLat: unalignedInt32(offset: 106) / 10_000_000,
        maxLon: unalignedInt32(offset: 110) / 10_000_000,
        maxLat: unalignedInt32(offset: 114) / 10_000_000,
        centerZoom: unalignedInt32(offset: 118),
        centerLon: unalignedInt32(offset: 119) / 10_000_000,
        centerLat: unalignedInt32(offset: 123) / 10_000_000,
      )
    }
